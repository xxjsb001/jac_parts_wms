...
/**补货下单*/
public class WmsReplenishmentMoveOrderShell extends Thorn4BaseShell {
	public static final String PAGE_ID = "wmsReplenishmentMoveOrderShell";
	private final WmsMoveRFManager rfWmsMoveManager;

	public WmsReplenishmentMoveOrderShell(WmsMoveRFManager rfWmsMoveManager) {
	...
	protected void mainProcess(Connection connection) throws BreakException,
		...
		List<Map<String, Object>> details = rfWmsMoveManager.findRuleTableBHKW();
		
		Integer isWorng = 0;
		List<Map<String, Object>> dds = new ArrayList<Map<String,Object>>();
		Object[] obj = rfWmsMoveManager.findLocBHKW(details, blCode, dds);
		isWorng = (Integer) obj[0];
		//{工艺状态=-, 货品代码=1023060GAZC, 补货上限=180.0, 供应商=L21016, 库位=A-03010101, 备料工工号=test}
		...
		if(beGo.equals("是")){
			this.forward(WmsReplenishmentMoveOrderDoShell.PAGE_ID,"继续扫");
		}else{
