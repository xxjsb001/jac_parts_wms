...
INSERT INTO ENUMERATE  VALUES (seq_enumerate.nextval,'WmsCountDetailStatus', 'COUNT');
INSERT INTO ENUMERATE  VALUES (seq_enumerate.nextval,'WmsCountDetailStatus', 'FINISHED');
INSERT INTO ENUMERATE  VALUES (seq_enumerate.nextval,'WmsCountDetailStatus', 'OPEN');
...
---费用大类
DELETE FROM ENUMERATE WHERE ENUM_TYPE = 'WMSBillingCategoryType';
INSERT INTO ENUMERATE  VALUES (seq_enumerate.nextval,'WMSBillingCategoryType', 'ACCOUNTING_SUBJECT');
INSERT INTO ENUMERATE  VALUES (seq_enumerate.nextval,'WMSBillingCategoryType', 'BIG_CATEGORY');
INSERT INTO ENUMERATE  VALUES (seq_enumerate.nextval,'WMSBillingCategoryType', 'SMALL_CATEGORY');
---结算模式
DELETE FROM ENUMERATE WHERE ENUM_TYPE = 'WMSBillingModel';
INSERT INTO ENUMERATE  VALUES (seq_enumerate.nextval,'WMSBillingModel', 'MONTH');
INSERT INTO ENUMERATE  VALUES (seq_enumerate.nextval,'WMSBillingModel', 'PACKAGES');
INSERT INTO ENUMERATE  VALUES (seq_enumerate.nextval,'WMSBillingModel', 'RECEIVE');
INSERT INTO ENUMERATE  VALUES (seq_enumerate.nextval,'WMSBillingModel', 'SIGNED');
INSERT INTO ENUMERATE  VALUES (seq_enumerate.nextval,'WMSBillingModel', 'SALE_AMOUNT');
---支付方式
DELETE FROM ENUMERATE WHERE ENUM_TYPE = 'WMSInvoicePayType';
INSERT INTO ENUMERATE  VALUES (seq_enumerate.nextval,'WMSInvoicePayType', 'THIRD_TRANSFER');
INSERT INTO ENUMERATE  VALUES (seq_enumerate.nextval,'WMSInvoicePayType', 'NOTHIRD_TRANSFER');
INSERT INTO ENUMERATE  VALUES (seq_enumerate.nextval,'WMSInvoicePayType', '-');

----发票状态
DELETE FROM ENUMERATE WHERE ENUM_TYPE = 'WMSInvoiceStatus';
INSERT INTO ENUMERATE  VALUES (seq_enumerate.nextval,'WMSInvoiceStatus', 'UNCHECKED');
INSERT INTO ENUMERATE  VALUES (seq_enumerate.nextval,'WMSInvoiceStatus', 'CHECKED');
INSERT INTO ENUMERATE  VALUES (seq_enumerate.nextval,'WMSInvoiceStatus', 'INVOICED');
INSERT INTO ENUMERATE  VALUES (seq_enumerate.nextval,'WMSInvoiceStatus', 'PAIED');

---账单明细来自
DELETE FROM ENUMERATE WHERE ENUM_TYPE = 'BillTypeFrom';
INSERT INTO ENUMERATE  VALUES (seq_enumerate.nextval,'BillTypeFrom', 'LFCS');
INSERT INTO ENUMERATE  VALUES (seq_enumerate.nextval,'BillTypeFrom', 'WMS');
---账单状态
DELETE FROM ENUMERATE WHERE ENUM_TYPE = 'BillStatus';
INSERT INTO ENUMERATE  VALUES (seq_enumerate.nextval,'BillStatus', 'UNCHECKED');
INSERT INTO ENUMERATE  VALUES (seq_enumerate.nextval,'BillStatus', 'CHECKED');


---采购发票状态
DELETE FROM ENUMERATE WHERE ENUM_TYPE = 'WMSPurchaseStatus';
INSERT INTO ENUMERATE  VALUES (seq_enumerate.nextval,'WMSPurchaseStatus', 'OPEN');
