...
public class CustomInventory implements IsSerializable {
	...
	public Object[] toArray() {
		return new Object[] { this.id, this.customItem.getId(),
			...
			this.availableQuantity, 0, this.lotInfo};//,this.supperCode,this.supperName
	}
	
	public String toLotInfor(String supplierCode,String supplierName,String soi,  String extendPropC1, String extendPropC2, 
