...
public class MiddleOrderJh extends VersionalEntity{
	...
	public MiddleOrderJh() {
		super();
		// TODO Auto-generated constructor stub
	}
	public MiddleOrderJh(String odrNo, WmsBillType billType, Date demandDate,
			...
			String station, String slr, WmsPackageUnit packageUnit,WHead head) {
		super();
		this.odrNo = odrNo;
		this.billType = billType;
		this.demandDate = demandDate;
