 ...
 *
 */
public class WmsReplenishmentPickShell extends PageableBaseShell{
	
	public static final String MOVEDOC_ID = "MOVEDOC_ID";
	public static final String PAGE_ID = "wmsReplenishmentPickShell";
	...
	public String getNextShell() {
		...
		return WmsReplenishmentPickLocShell.PAGE_ID;
	}
