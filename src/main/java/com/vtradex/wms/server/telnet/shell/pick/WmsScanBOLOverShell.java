 ...
 *
 */
public class WmsScanBOLOverShell extends Thorn4BaseShell{
	public static final String CURRENT_LICENSE = "CURRENT_LICENSE";
	public static final String CURRENT_DTOS = "CURRENT_DTOS";
	public static final String ERROR_MESSAGE = "ERROR_MESSAGE";
	public static final String PAGE_ID = "wmsScanBOLOverShell";
	private final WmsPickRFManager pickRFManager;
	
	public WmsScanBOLOverShell(WmsPickRFManager pickRFManager) {
	...
	protected void mainProcess(Connection connection) throws BreakException,
		...
		this.output("请耐心等待...");
		try{
			pickRFManager.createWmsScanBol(dtos,license);
		}catch(Exception e){
			this.put(CURRENT_LICENSE, license);
			this.forward(WmsScanBOLShell.PAGE_ID,JavaTools.spiltLast(e.getMessage(), ":"));
		}
		...
		this.forward(WmsScanBOLShell.PAGE_ID,ShellExceptions.NEXT_VEHICLE);
	}
}
